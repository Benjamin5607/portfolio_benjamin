...
const PROJECT_I18N = {
  ...
  zerro_ai_landing: {
    desc: {
      en: "Zerro AI — multi-agent Workspace OS + Dev Studio. Web IDE, Windows desktop app, agent-first pastel-mint UI, EN/KO, Swarm Engine, Ollama, GitHub/local deploy.",
      ko: "Zerro AI — 멀티에이전트 Workspace OS + Dev Studio. 웹 IDE, Windows 데스크톱 앱, 에이전트 중심 파스텔 민트 UI, EN/KO, Swarm Engine, Ollama, GitHub/로컬 배포.",
      zh: "Zerro AI — 多 Agent Workspace OS + Dev Studio。Web IDE、Windows 桌面应用、Agent 优先的粉彩薄荷绿 UI、EN/KO、Swarm Engine、Ollama、GitHub/本地部署。",
      ja: "Zerro AI — マルチエージェント Workspace OS + Dev Studio。Web IDE、Windows デスクトップ、エージェント中心のパステルミント UI、EN/KO、Swarm Engine、Ollama、GitHub/ローカルデプロイ。",
    },
    stackDetail: {
      en: [
        "Dev Studio — agent-first pastel-mint IDE (web + Electron desktop)",
        "Windows Setup.zip installer · Ollama one-click · native FS / Shell",
        "Swarm Engine — curated models, Auto failover / MAX mode",
        "EN default + 한국어 UI · GitHub PAT / local workspace targets",
        "Parallel Swarm · Supabase RAG · MCP-ready tool hub",
        "Live: zerroai.space · Install: benjamin5607.github.io/zerro_ai_landing/dev-studio.html",
      ],
      ko: [
        "Dev Studio — 에이전트 중심 파스텔 민트 IDE (웹 + Electron 데스크톱)",
        "Windows Setup.zip · Ollama 원클릭 · 네이티브 FS / Shell",
        "Swarm Engine — 모델 목록, Auto 폴백 / MAX 모드",
        "영어 기본 + 한국어 UI · GitHub PAT / 로컬 워크스페이스",
        "Parallel Swarm · Supabase RAG · MCP 도구 허브",
        "Live: zerroai.space · 설치: benjamin5607.github.io/zerro_ai_landing/dev-studio.html",
      ],
      zh: [
        "Dev Studio — Agent 优先粉彩薄荷绿 IDE（Web + Electron）",
        "Windows Setup.zip · Ollama 一键 · 原生 FS / Shell",
        "Swarm Engine — 模型列表、Auto 故障转移 / MAX",
        "英语默认 + 韩语 UI · GitHub PAT / 本地工作区",
        "Parallel Swarm · Supabase RAG · MCP 工具中心",
        "Live: zerroai.space · 安装页: benjamin5607.github.io/zerro_ai_landing/dev-studio.html",
      ],
      ja: [
        "Dev Studio — エージェント中心パステルミント IDE（Web + Electron）",
        "Windows Setup.zip · Ollama ワンクリック · ネイティブ FS / Shell",
        "Swarm Engine — モデル一覧、Auto フェイルオーバー / MAX",
        "英語デフォルト + 韓国語 UI · GitHub PAT / ローカルワークスペース",
        "Parallel Swarm · Supabase RAG · MCP ツールハブ",
        "Live: zerroai.space · インストール: benjamin5607.github.io/zerro_ai_landing/dev-studio.html",
      ],
    },
  },
  space_manger: {
